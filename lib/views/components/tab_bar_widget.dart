...
class TabWidget extends StatefulWidget {
  const TabWidget({super.key, required this.tabList, required this.controller});
...
class _TabWidgetState extends State<TabWidget> with TickerProviderStateMixin {
  ...
  final Color _foregroundOff = AppColors.hintColor;

  // active button's background color
  final Color _backgroundOn = AppColors.secondary;
  final Color _backgroundOff = AppColors.timeSelector;
  ...
  _handleTabAnimation() {
    ...
    // if the button wasn't pressed, which means the user is swiping, and the amount swiped is less than 1 (this means that we're swiping through neighbor Tab Views)
