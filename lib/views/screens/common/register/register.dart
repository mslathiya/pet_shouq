                                  ...
                                  children: [
                                    ...
                                    InputField(
                                      headerWidget: InputHeader(
                                        compulsory: true,
                                        headerLabel:
                                            t.translate("veterinarian_special"),
                                      ),
                                        ...
                                        Expanded(
                                          child: InputField(
                                            headerWidget: InputHeader(
                                              compulsory: false,
                                              headerLabel:
                                                  t.translate("lbl_gender"),
                                            ),
                                            inputHint:
                                                t.translate("hint_gender"),
                                            suffixIcon: SizedBox(
                                              width: 24.w,
                                              height: 24.h,
                                              child: IconButton(
                          ...
                          selectedOption == 1
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    InputField(
                                      inputHint:
                                          t.translate("hint_street_address"),
                                    ),
                                    SizedBox(
                                      height: 15.h,
                                    ),
                                    InputField(
                                      inputHint: t
                                          .translate("hint_street_address_two"),
                                    ),
                                    SizedBox(
                                      height: 15.h,
                                    ),
                                        ...
                                        Expanded(
                                          child: InputField(
                                            headerWidget: InputHeader(
                                              compulsory: false,
                                              headerLabel:
                                                  t.translate("lbl_province"),
                                            ),
                                            inputHint:
                                                t.translate("hint_province"),
                                          ),
                                        )
                                      ],
                                    ),
                                    ...
                                    PhoneInput(
                                      headerLabel:
                                          t.translate("lbl_secondary_phone"),
                                    ),
                                    SizedBox(
                                      height: 15.h,
                                    ),
                                    ...
                                    InputField(
                                      ...
                                      headerWidget: InputHeader(
                                        compulsory: false,
                                        headerLabel:
                                            t.translate("lbl_mailing_address"),
                                      ),
                                      inputHint:
                                          t.translate("hint_mailing_address"),
                                    ),
                                  ],
                                )
                              : Column(
                                  ...
                                  children: [
                                    InputField(
                                      headerWidget: InputHeader(
                                        compulsory: false,
                                        headerLabel:
                                            t.translate("lbl_qualification"),
                                      ),
                                      inputHint:
                                          t.translate("hint_qualification"),
                                      compulsory: true,
                                    ),
                                    SizedBox(
                                      height: 15.h,
                                    ...
                                    InputField(
                                      headerWidget: InputHeader(
                                        compulsory: false,
                                        headerLabel:
                                            t.translate("lbl_profile_summary"),
                                      ),
                                    ...
                                    InputField(
                                      headerWidget: InputHeader(
                                        compulsory: false,
                                        headerLabel:
                                            t.translate("lbl_language_spoken"),
                                      ),
                                        ...
                                        Expanded(
                                          child: InputField(
                                            headerWidget: InputHeader(
                                              compulsory: false,
                                              headerLabel:
                                                  t.translate("lbl_country"),
                                            ),
                                            inputHint:
                                                t.translate("hint_country"),
                                          ),
                                        ),
                                        SizedBox(
                                          width: 10.w,
