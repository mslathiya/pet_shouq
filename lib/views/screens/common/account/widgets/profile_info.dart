...
class ProfileInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      Vet? vetData = userData.vet;
      String primaryPhone = userType == UserType.typeVet
          ? '+${vetData?.vetContactNumberCountryCode ?? ""} ${vetData?.vetContactNumber ?? ""}'
                    ...
                    : Column(
                        ...
                        children: [
                          Align(
                            ...
                            child: EditButton(
                              onPressEdit: () {
                                if (userType == UserType.typeParent) {
                                  Get.toNamed(
                                    editParentProfile,
                                  );
                                } else {
                                  Get.find<EditParentProfileController>()
                                      .updateVetInfo(vetData!);
                                  Get.toNamed(
                                    vetEditProfile,
                                  );
                                }
                          ...
                          LabelWithIcon(
                            ...
                            value: userType == UserType.typeVet
                                ? "${vetData?.vetAddress ?? ""} ${vetData?.vetCity ?? ""} ${vetData?.vetLocation ?? ""} ${vetData?.vetState ?? ""}"
              ...
              ? Column(
                  children: [
                    SingleLabelItem(
                      ...
                      subTitle: vetData?.vetSpeciality ?? "",
