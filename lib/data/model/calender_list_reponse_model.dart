...
//
//     final calenderListResponseModel = calenderListResponseModelFromJson(jsonString);

import 'dart:convert';

CalenderListResponseModel calenderListResponseModelFromJson(String str) => CalenderListResponseModel.fromJson(json.decode(str));

String calenderListResponseModelToJson(CalenderListResponseModel data) => json.encode(data.toJson());

class CalenderListResponseModel {
  bool? success;
  String? message;
  Data? data;

  CalenderListResponseModel({
    this.success,
    this.message,
    this.data,
  });

  factory CalenderListResponseModel.fromJson(Map<String, dynamic> json) => CalenderListResponseModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    data: json["data"] == null ? [] : List<CalenderListData>.from(json["data"]!.map((x) => CalenderListData.fromJson(x))),
...
class CalenderListData {
  ...
  factory CalenderListData.fromJson(Map<String, dynamic> json) => CalenderListData(
    id: json["id"],
    vetId: json["vet_id"],
    petId: json["pet_id"],
